...
이 스킬은 특정 프로젝트의 내용을 직접 외워서 설명하는 스킬이 아닙니다. 대신 Codex가 대상 저장소를 읽고, 그 저장소에 맞는 repo-local handoff agent를 설계하고, 첫 응답과 로드맵과 검증 루프를 만들도록 이끕니다.
...
통과 기준은 "좋은 설명 문서가 생겼는가"가 아니라 "에이전트가 실제로 사람을 이끌 수 있는가"입니다.
